  ...
  return (
    <>
      <section className="pt-40 md:pt-48 pb-16 container-luxe">
        <FadeIn>
          <p className="text-[10px] tracking-[0.4em] uppercase text-foreground/60">
            ⊹ Get in Touch
          </p>
        </FadeIn>
        <StaggerText
        ...
        <FadeIn delay={0.6}>
          <p className="mt-8 text-lg text-foreground/65 max-w-2xl leading-relaxed">
            For quotes, commissions, training enrollment, or simply a question - WhatsApp is the
            fastest route. We respond within working hours.
          </p>
        </FadeIn>
      </section>
          ...
          {[
            {
              Icon: MapPin,
              label: "Atelier",
              value: "7, Prince Ola Street, Seliat Busstop, Idimu Road, Egbeda, Lagos.",
            },
            ...
            },
            {
              Icon: Mail,
              label: "Email",
              value: "hello@kenavidmonogram.com",
              href: "mailto:hello@kenavidmonogram.com",
            },
            {
              Icon: Instagram,
              label: "Instagram",
