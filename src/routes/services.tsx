...
const services = [
  ...
  },
  {
    ...
    feats: ["Vector cleanup", "Stitch path engineering", "Multi-fabric tested", "DST/PES/EXP files"],
  },
  {
    n: "03",
    img: m15,
  ...
  },
  {
    ...
    feats: ["Back-piece embroidery", "Sleeve & chest", "Tailor signatures", "Capsule collaborations"],
  },
  {
    n: "05",
    img: m6,
    ...
    <>
        ...
        <div className="grid lg:grid-cols-12 gap-10 mb-16">
          ...
          <FadeIn delay={0.15} className="lg:col-span-6 lg:col-start-7">
            <p className="text-lg text-foreground/70 leading-relaxed">
              Whether it's a single monogrammed handkerchief for a wedding gift
              or five hundred uniforms for a hospitality launch, we bring the
              same patient calibration to every job. No shortcuts, no excuses.
            </p>
            <div className="mt-8 flex flex-wrap gap-4">
              <WhatsAppButton message={waMessages.production}>Request a Quote</WhatsAppButton>
              <WhatsAppButton message={waMessages.bulk} variant="outline">Bulk Order</WhatsAppButton>
            </div>
          </FadeIn>
        </div>
          ...
          <div>
            ...
            <FadeIn delay={0.2}>
              <p className="mt-6 text-foreground/70 leading-relaxed">
                We stock high-tensile polyester, mercerized cotton, and metallic
                threads sourced from established mills. Color matched to brand
                guidelines and tested on your fabric before any production run.
              </p>
            </FadeIn>
            <FadeIn delay={0.3}>
      ...
      <section className="container-luxe py-24 md:py-32">
        ...
        <div className="mt-16 grid md:grid-cols-3 gap-6">
          {[
            { t: "Single Piece", p: "From ₦8,000", d: "Personal monograms, gifts, single garment commissions.", m: waMessages.production },
            { t: "Bulk Production", p: "Volume Tiered", d: "50+ pieces. Per-unit pricing decreases with quantity.", m: waMessages.bulk },
            { t: "Digitization", p: "From ₦15,000", d: "Logo conversion to stitch-perfect file. Reusable forever.", m: waMessages.digitization },
          ].map((c, i) => (
            <FadeIn key={c.t} delay={i * 0.1}>
              <div className="border hairline p-8 md:p-10 h-full flex flex-col group hover:bg-foreground hover:text-background transition-colors duration-500">
                <p className="text-xs uppercase tracking-[0.3em] text-[oklch(0.7_0.09_80)]">{c.t}</p>
      ...
      <section className="bg-foreground text-background py-24 md:py-32">
        <div className="container-luxe text-center">
          <FadeIn>
            <p className="text-[10px] tracking-[0.32em] uppercase text-background/60">⊹ Ready to Begin</p>
          </FadeIn>
          <FadeIn delay={0.1}>
      ...
      <div className="container-luxe relative">
        ...
        <FadeIn delay={0.6}>
          <p className="mt-8 text-lg text-background/70 max-w-2xl leading-relaxed">
            From single bespoke commissions to high-volume corporate orders —
            we handle the full spectrum of premium machine embroidery.
          </p>
        </FadeIn>
      </div>
    </section>
